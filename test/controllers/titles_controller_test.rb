...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { author: @title.author, content: @title.content } }, as: :json
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { author: @title.author, content: @title.content } }, as: :json
    assert_response 200
  end
